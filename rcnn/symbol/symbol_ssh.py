...
def get_ssh_conv(data):
    ...
    relu1_1 = conv_act_layer(data, 'conv1_1',
    ...
    relu1_2 = conv_act_layer(relu1_1, 'conv1_2',
        64, kernel=(3,3), pad=(1,1), stride=(1, 1), act_type='relu')
    ...
    relu2_1 = conv_act_layer(pool1, 'conv2_1',
        128, kernel=(3,3), pad=(1,1), stride=(1, 1), act_type='relu')
    #conv2_2 = mx.symbol.Convolution(
    #    data=relu2_1, kernel=(3, 3), pad=(1, 1), num_filter=128, workspace=2048, name="conv2_2")
    #relu2_2 = mx.symbol.Activation(data=conv2_2, act_type="relu", name="relu2_2")
    relu2_2 = conv_act_layer(relu2_1, 'conv2_2',
        128, kernel=(3,3), pad=(1,1), stride=(1, 1), act_type='relu')
